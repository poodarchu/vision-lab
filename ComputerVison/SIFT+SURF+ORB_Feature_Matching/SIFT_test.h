...
#ifndef OPENCV_BASICS_SIFT_TEST_H
#define OPENCV_BASICS_SIFT_TEST_H
...
void SIFT_test() {
    ...
    string image1_name = string("/Users/poodar/Developments/Cpp/ClionProjects/OpenCV_Basics/images/vip.jpeg");
    string image2_name = string("/Users/poodar/Developments/Cpp/ClionProjects/OpenCV_Basics/images/vipScene.jpeg");

    Mat image1 = imread(image1_name);
    Mat image2 = imread(image2_name);
...
#endif //OPENCV_BASICS_SIFT_TEST_H
